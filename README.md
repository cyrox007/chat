...
Release candidate текущей ветки: `0.6.21-alpha.1` — UI motion/loading polish. Последний выпущенный `main` checkpoint — `0.6.20-alpha.1`.
