...
- [`web-application-maturity-v1.md`](web-application-maturity-v1.md) — PWA shell, безопасный offline contract, notification lifecycle и внешний reminder worker; активный `0.5.5-alpha.x` slice.
