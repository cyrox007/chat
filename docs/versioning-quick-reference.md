...
- Current release candidate: **0.6.21-alpha.2** — mobile routed-content/session hotfix.
- Last released `main` checkpoint: **0.6.21-alpha.1** until the final exact-head gate passes and the release candidate merges.
