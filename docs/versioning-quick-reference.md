...
- Current release candidate: **0.6.14-alpha.1** — privacy-minimal anti-spam / raid behavioral signals.
- Last released `main` checkpoint: **0.6.13-alpha.1** until PR #34 passes the final exact-head gate and merges.
