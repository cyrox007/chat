...
- Current release candidate: **0.6.21-alpha.1** — UI motion/loading polish.
- Last released `main` checkpoint: **0.6.20-alpha.1** until the final exact-head gate passes and the release candidate merges.
