...
- Current release candidate: **0.6.16-alpha.1** — Trust & Safety operations metrics, incident rehearsal and default-off protective holds.
- Last released `main` checkpoint: **0.6.15-alpha.1** until PR #36 passes the final exact-head gate and merges.
...
- Active next Trust & Safety task after this checkpoint: formal private-evidence privacy-retention/secure-expiry and production calibration before any protective-hold enablement.
- Still open before beta: moderation privacy-retention/secure-expiry and production calibration, anonymized production-like legacy snapshot rehearsal, member-capacity concurrency, DST-correct recurrence, production-like load/pool profiling, observability, Safari/WebKit/security/accessibility hardening and unit-economics/monetization planning.
