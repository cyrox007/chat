...
- Current release candidate: **0.6.13-alpha.1** — provider-neutral moderation AI copilot.
- Last released `main` checkpoint: **0.6.12-alpha.1** until PR #33 passes the final exact-head gate and merges.
