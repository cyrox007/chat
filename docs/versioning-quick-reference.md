...
- Current release candidate: **0.6.22-alpha.1** — Space member-capacity concurrency hardening.
- Last released `main` checkpoint: **0.6.21-alpha.2** until the final exact-head gate passes and the release candidate merges.
