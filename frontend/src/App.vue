		...
		<transition name="fade">
			...
			>
				<div class="connection-notice__content">
					...
					<span>Проверьте подключение. Мы попробуем восстановить соединение при следующем действии.</span>
				</div>
				<button
					type="button"
					class="connection-notice__close"
...
.connection-notice__close:hover {
...
.fade-leave-active {
	transition:
		opacity var(--ui-motion-normal) var(--ui-ease),
		transform var(--ui-motion-normal) var(--ui-ease);
}
