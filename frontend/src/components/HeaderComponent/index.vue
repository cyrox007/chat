		...
		<div class="topbar-inner container">
			...
			<div class="topbar-actions">
				...
				<div v-if="isAuthenticated" class="persona-menu">
					<button class="persona-trigger" :class="{ 'persona-trigger--open': isDropdownOpen }" type="button" :aria-expanded="isDropdownOpen" aria-haspopup="menu" @click="toggleDropdown">
					...
					<Transition name="ui-popover">
						<div v-if="isDropdownOpen" class="persona-dropdown" role="menu">
							...
							<button role="menuitem" type="button" :disabled="isLoggingOut" :aria-busy="isLoggingOut ? 'true' : 'false'" @click="handleLogout">
								<span v-if="isLoggingOut" class="ui-spinner" aria-hidden="true"></span>
