...
const createActivity = async () => {
	...
	try {
		...
		Object.assign(activityDraft, { title: '', description: '', activity_type: 'hangout', starts_at: '', recurrence: 'none' });
